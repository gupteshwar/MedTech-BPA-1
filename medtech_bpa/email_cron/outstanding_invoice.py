...
def send_invoice_summary_email():
    ...
    # Fetch recipient emails, customer group, and order type from Outstanding Invoice Email Settings
    ...
    order_type = email_settings.get("order_type")  # Fetch order_type
    ...
    print("Order Type:", order_type if order_type else "Not Specified (No Filter Applied)")
    ...
    # Apply order_type filter if it is set
    if order_type:
        invoice_filters["order_type"] = order_type
